...
function n2021() {
    document.getElementById('date').src = '2021date.png';//change this
    document.getElementById('img1').src = '2021ins.png';//change this
    ...
    document.getElementById('textDate').innerHTML='Jan 6 2021'
...
function n1941() {
    document.getElementById('date').src = '1941date.png';//change this
    document.getElementById('img1').src = 'rose.png';//change this
    ...
    document.getElementById('textDate').innerHTML='Jan 6 1941'
...
function n1966() {
    document.getElementById('date').src = '1966-512.png';//change this
    document.getElementById('img1').src = 'ar rahman-512.png';//change this
    ...
    document.getElementById('textDate').innerHTML='Jan 6 1966'
    document.getElementById('textAgain').innerHTML='Carrer Overview'
    document.getElementById('realText').innerHTML="A.R. Rahman, acclaimed as 'the Mozart of Madras,' stands as a musical luminary in the realm of Indian and global music. Born in Madras (now Chennai), India, on January 6, 1967, Rahman's journey is a testament to his unparalleled talent and groundbreaking contributions to the world of film and contemporary music. Renowned for his innovative compositions and mastery of various musical genres, Rahman has left an indelible mark on the Indian film industry and beyond. His foray into the international scene was marked by the iconic soundtrack for 'Roja'in 1992, which garnered widespread acclaim. Rahman's unique ability to blend traditional Indian sounds with modern musical elements has earned him numerous accolades, including two Academy Awards, two Grammy Awards, and a BAFTA Award. Beyond his musical prowess, Rahman is known for his humanitarian efforts and commitment to social causes. His enduring legacy continues to inspire aspiring musicians globally, solidifying his status as a musical maestro and a cultural ambassador for India on the world stage."
}
//calling 1993
function n1993() {
    document.getElementById('date').src = '1993date.png';//change this
    document.getElementById('img1').src = 'dizzy.png';//change this
    ...
    document.getElementById('textDate').innerHTML='Jan 6 1993'
...
function n1878() {
    document.getElementById('date').src = '1878date.png';//change this
    document.getElementById('img1').src = 'sandburg.png';//change this
    ...
    document.getElementById('textDate').innerHTML='Jan 6 1878'
